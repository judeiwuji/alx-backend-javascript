  ...
  describe('SUM', () => {
    ...
    describe('Float', () => {
      ...
      it('should return 5 for 2.5, 2.3', () => {
        expect(calculateNumber('SUM', 2.5, 2.3)).to.equal(5);
      });

      it('should return -4 for -2.5, -2.3', () => {
        expect(calculateNumber('SUM', -2.5, -2.3)).to.equal(-4);
      });
    });
    ...
    describe('Integer and Float', () => {
      ...
      it('should return 1 for -1.7, 3', () => {
        expect(calculateNumber('SUM', -1.7, 3)).to.equal(1);
      });
  ...
  describe('SUBTRACT', () => {
    ...
    describe('Float', () => {
      ...
      it('should return 1 for 2.5, 2.3', () => {
        expect(calculateNumber('SUBTRACT', 2.5, 2.3)).to.equal(1);
      });

      it('should return 0 for -2.5, -2.3', () => {
        expect(calculateNumber('SUBTRACT', -2.5, -2.3)).to.equal(0);
      });
    });
    ...
    describe('Integer and Float', () => {
      ...
      it('should return -5 for -1.7, 3', () => {
        expect(calculateNumber('SUBTRACT', -1.7, 3)).to.equal(-5);
      });
  ...
  describe('DIVIDE', () => {
    ...
    describe('Float', () => {
      ...
      it('should return 1.5 for 2.5, 2.3', () => {
        expect(calculateNumber('DIVIDE', 2.5, 2.3)).to.equal(1.5);
      });

      it('should return 1 for -2.5, -2.3', () => {
        expect(calculateNumber('DIVIDE', -2.5, -2.3)).to.equal(1);
      });
    });
